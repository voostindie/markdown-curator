...
/// Represents a nested list of lines as a tree to compute the line values.
///
...
/// band around the tree and incrementally number each node. Once you're done you each node in the
/// tree will have two numbers: one to the left, one to the right. Given these numbers, it's very
/// easy to compute the parents and children of any node, in linear time.
///
