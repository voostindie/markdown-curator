...
/// making sure all processors in the system run in the correct order: all producers of a payload
/// type before all consumers of that payload type.
public interface ChangeProcessor
{
    ...
    /// Returns the set of payload types that this model can consume from changelogs; this defaults
    /// to the built-in types from the vault: [Vault], [Document] and [Folder].
    ///
    ...
    default Set<Class<?>> consumedPayloadTypes()
    {
